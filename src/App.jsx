  ...
  return (
    <div style={{ fontFamily: "'DM Sans','Helvetica Neue',sans-serif", background: "#FAFAF8", color: "#1a1a1a", overflowX: "hidden" }}>
      ...
      <nav style={{ position: "sticky", top: 0, zIndex: 100, background: "rgba(250,250,248,0.95)", backdropFilter: "blur(12px)", borderBottom: "1px solid #e8e6e1", padding: "0 20px" }}>
        <div style={{ maxWidth: 1140, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: 58 }}>
          ...
          <div className="nav-links" style={{ display: "flex", gap: 22, alignItems: "center", fontSize: 13.5 }}>
            ...
            <a href="https://wa.me/919735577182?text=Hi%2C%20I%20want%20to%20automate%20my%20business" target="_blank" rel="noreferrer" style={{ background: "#25D366", color: "#fff", padding: "8px 16px", borderRadius: 8, fontWeight: 600, fontSize: 12.5, textDecoration: "none" }}>💬 Get Started</a>
          </div>
        ...
        {menuOpen && <div className="mobile-menu-show" style={{ display: "flex", flexDirection: "column", paddingBottom: 10, borderTop: "1px solid #eee" }}>
          ...
          <a href="https://wa.me/919735577182" target="_blank" rel="noreferrer" onClick={() => setMenuOpen(false)} style={{ margin: "8px 16px", background: "#25D366", color: "#fff", padding: "10px 0", borderRadius: 8, fontWeight: 600, fontSize: 13, textDecoration: "none", textAlign: "center" }}>💬 Get Started Free</a>
        </div>}
      </nav>
      ...
      <section className="hero-flex" style={{ maxWidth: 1140, margin: "0 auto", padding: "60px 20px 46px", display: "flex", alignItems: "center", gap: 46, flexWrap: "wrap" }}>
        <div style={{ flex: "1 1 450px", minWidth: 270 }}>
          ...
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
            <a href="https://wa.me/919735577182?text=Hi%2C%20I%20want%20a%20free%20demo" target="_blank" rel="noreferrer" style={{ background: "#075E54", color: "#fff", padding: "12px 24px", borderRadius: 10, fontWeight: 600, fontSize: 14.5, textDecoration: "none", boxShadow: "0 4px 14px rgba(7,94,84,0.3)" }}>Get Free Demo →</a>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 16 }}>
            {[
              ...
              <div key={plan.name} style={{ border: plan.cta ? "2px solid #075E54" : "1px solid #eee", borderRadius: 14, padding: "26px 20px", background: plan.cta ? "linear-gradient(180deg,#f0faf4 0%,#fff 100%)" : "#fff", position: "relative", transition: "transform 0.2s, box-shadow 0.2s" }} onMouseOver={e => { e.currentTarget.style.transform = "translateY(-3px)"; e.currentTarget.style.boxShadow = "0 10px 28px rgba(0,0,0,0.06)"; }} onMouseOut={e => { e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "none"; }}>
                ...
                <a href={`https://wa.me/919735577182?text=Hi%2C%20I'm%20interested%20in%20${plan.name}%20plan`} target="_blank" rel="noreferrer" style={{ display: "block", textAlign: "center", marginTop: 18, padding: "11px 0", borderRadius: 9, fontWeight: 600, fontSize: 13.5, textDecoration: "none", background: plan.cta ? "#075E54" : "transparent", color: plan.cta ? "#fff" : "#075E54", border: plan.cta ? "none" : "2px solid #075E54" }}>Start Free Trial →</a>
              </div>
            ))}
          </div>
      ...
      <section style={{ background: "#075E54", padding: "46px 20px", textAlign: "center" }}>
        ...
        <a href="https://wa.me/919735577182?text=Hi%2C%20I%20want%20to%20automate%20my%20business" target="_blank" rel="noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "#25D366", color: "#fff", padding: "13px 30px", borderRadius: 11, fontWeight: 700, fontSize: 15.5, textDecoration: "none", boxShadow: "0 4px 20px rgba(37,211,102,0.4)" }}>💬 Chat with us on WhatsApp</a>
      </section>
